...
class PricesFormatterTest(unittest.TestCase):
    def setUp(self) -> None:
        self.survey_metadata: SubmissionMetadata = SubmissionMetadata(
            survey_id = "132",
            period_id = "201605",
            ru_ref = "23456789012A",
            form_type = "0001",
    ...
    def test_ppi(self):
        ...
        ppi_formatter.add_data("0", {"9995": "1"})
        ppi_formatter.add_data("12345678901", {"9999": "0", "9997": "200", "9996": "1"})
        ppi_formatter.add_data("98765432101", {"9999": "0", "9997": "400", "9996": "1"})
    ...
    def test_sppi(self):
        ...
        sppi_formatter.add_data("0", {"9995": "1"})
        sppi_formatter.add_data("7732015057", {"9999": "0", "9997": "1000", "9996": "1"})
        sppi_formatter.add_data("7732016043", {"9999": "0", "9997": "2000", "9996": "1"})
