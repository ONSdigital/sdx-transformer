...
class Period:
    ...
    def __init__(self, period_id: str, period_format: Optional[str] = None):
        self._period_id = period_id
        if period_format is None or len(period_format) != len(period_id):
            if len(period_id) == 6:
                pf = "YYYYMM"
    ...
    def convert_to_YYYYMMDD(self) -> str:
        return self.convert_to_format("YYYYMMDD")
    ...
    def __ge__(self, other):
        ...
        return self.convert_to_YYYYMMDD() >= other.convert_to_YYYYMMDD()
